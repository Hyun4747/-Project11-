...
async function Lending(){
  ...
  console.log(`Total collateral enabled asset: ${collateralEnabledSum} KRW`);
  for(let k in asset_contract){//0보다 큰것만 출력해야합니다.
  ...
  console.log(`Minted: ${mintedBalance} ( ${mintedBalance * tokenPriceInKRW.VAI} KRW )`);
  ...
  console.log(`Staked VAI: ${staked} ( ${staked * tokenPriceInKRW.VAI} KRW )`);//user staked amount
  ...
  console.log(`Claimable: ${pendingXVS} ( ${pendingXVS * tokenPriceInKRW.XVS} KRW )`);//vault에 claim
  ...
  console.log(`Collectable: ${collectable} ( ${collectable * tokenPriceInKRW.XVS} KRW )`);//vote에 collect

  console.log("");
  //자산 총합을 출력해줍니다. in KRW
  console.log(`Total Asset: ${supplyBalanceSum_KRW + borrowBalanceSum_KRW + (mintedBalance * tokenPriceInKRW.VAI)} KRW`);
  console.log(`Pure Asset: ${supplyBalanceSum_KRW} KRW`);
  console.log(`debt: ${borrowBalanceSum_KRW + (mintedBalance * tokenPriceInKRW.VAI)} KRW`);
